...
export default function PrivacyPolicy() {
  return (
    <main id="conteudo-principal" tabIndex={-1} className="safe-inline min-h-screen scroll-mt-24 bg-slate-50 px-4 pb-16 pt-28 outline-none dark:bg-navy-950 sm:px-6">
